        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl border border-slate-200/90 shadow-xl overflow-hidden">
            ...
            <div className="bg-[#0F172A] text-slate-200 px-3 sm:px-4 py-3 border-b border-[#0F172A]">
              ...
              {/* Mode switch */}
              <div className="flex items-center self-start sm:self-auto bg-slate-800 p-0.5 rounded-lg text-[10px] sm:text-xs max-w-full overflow-x-auto">
                <button
                ...
                <button
                  ...
                  className={`px-2.5 sm:px-3 py-1 rounded-md transition-all flex items-center gap-1 whitespace-nowrap ${
            ...
            {/* Bottom summary bar */}
            <div className="bg-white px-4 sm:px-5 py-3.5 border-t border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
